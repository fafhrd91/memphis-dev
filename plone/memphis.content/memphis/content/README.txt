...
===============
  ...
  Memphis content implements high level data/behavior binding
...
behaviors, relations.
  ...
  This three primitives are composed by `Instance` object. But instance
itself doesn't provide any functionality. This instance is nothing more than 
point of composition of actual data and implementation. Instance just provides
